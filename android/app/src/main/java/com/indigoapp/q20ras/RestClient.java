...
public class RestClient {
  ...
  public void request(String baseURL, JSONObject param, final Handler.Callback onSuccess, final Handler.Callback onError) {
    ...
    if (!isNetworkAvailable(ctx)) {
      onError.handleMessage(getMsg("No network available!"));
      return;
    }
      ...
      new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
          ...
          try {
            ...
            if (Result.equals("erSucceed")) onSuccess.handleMessage(getMsg(jResp));
            else onError.handleMessage(getMsg(Result));
